...
class _TelaCadastroState extends State<TelaCadastro>
  ...
  final AutenticacaoUsuario _auth = AutenticacaoUsuario();
  ...
  Future<void> _handleCadastro() async {
    ...
    try {
      ...
      final resultado = await _auth.cadastrar(dadosCadastro);

      if (!mounted) return;

      if (resultado != null) {
        _showErrorSnackBar("Erro ao cadastrar usuário: $resultado.");
        return;
      }

      _showSuccessSnackBar("Usuário cadastrado com sucesso!");
  ...
  Widget _buildCityDropdown() {
    return Container(
      ...
      child: DropdownButtonFormField<int>(
        ...
        onChanged: _isLoading ? null : (int? novoValor) {
          setState(() {
        ...
        child: Row(
          ...
          children: [
            ...
            AnimatedContainer(
              ...
              child: TextButton(
                onPressed: _isLoading ? null : _navigateToLoginFromLink,
