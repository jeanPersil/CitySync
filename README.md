...
|---------------------------|----------------------------|-----------------------------|
| ![Tela de cadastro](citysync/assets/TelaCadastro.png) | ![Tela de login](citysync/assets/telaLogin.png) | ![Tela principal (mapa)](citysync/assets/TelaPrincipal.png) |

| Tela de report de problemas | Tela listagem de problemas | Tela configurações         |
|-----------------------------|----------------------------|----------------------------|
| ![Tela de report](citysync/assets/TelaReport.png) | ![Listagem de problemas](citysync/assets/ListagemProblemas.png) | ![Tela configurações](citysync/assets/Config.png) |
