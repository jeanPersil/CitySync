...
function inicializarElementos() {
    elementos = {
        ...
        changePasswordBtn: document.querySelector('.cartao-configuracao:nth-of-type(2) .botao-acao:nth-of-type(1)'),
        manageDevicesBtn: document.querySelector('.cartao-configuracao:nth-of-type(2) .botao-acao:nth-of-type(2)'),
        editButtons: document.querySelectorAll('.tabela-configuracoes .botao-acao:nth-of-type(1)'),
        deleteButtons: document.querySelectorAll('.tabela-configuracoes .botao-acao:nth-of-type(2)')
    };
}
...
function mostrarModal2FA() {
    ...
    document.getElementById('confirmar2FA').addEventListener('click', () => fecharModal2FA(true));
    document.getElementById('cancelar2FA').addEventListener('click', () => fecharModal2FA(false));
...
function mostrarModalAlteracaoSenha() {
    ...
    document.getElementById('confirmarAlteracaoSenha').addEventListener('click', validarEAlterarSenha);
    document.getElementById('cancelarAlteracaoSenha').addEventListener('click', fecharModalAlteracaoSenha);
...
function validarEAlterarSenha() {
    ...
    if (senhaAtual !== 'suaSenhaAtual') { // Substitua por uma validação real
    ...
    if (novaSenha.length < 6) {
        mostrarNotificacao('A nova senha deve ter pelo menos 6 caracteres.', 'erro');
        return;
    }
...
function excluirUsuario(index) {
    ...
    if (linhas[index]) {
        ...
        document.getElementById('confirmarExclusao').addEventListener('click', () => fecharModalExclusao(true, linhas[index]));
        document.getElementById('cancelarExclusao').addEventListener('click', () => fecharModalExclusao(false));
...
function mostrarModalEdicaoUsuario(linha) {
    ...
    const statusAtual = linha.querySelector('.status').classList.contains('status-ativo');
    ...
    document.getElementById('salvarEdicao').addEventListener('click', () => salvarEdicaoUsuario(linha));
    document.getElementById('cancelarEdicao').addEventListener('click', fecharModalEdicaoUsuario);
    ...
    const statusLabel = editStatusToggle.closest('.opcao-configuracao').querySelector('label:first-child');
